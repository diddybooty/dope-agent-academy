...
export const QUIZ: QuizQ[] = [
  ...
  },
  {
    ...
    choices: [
      "NGR, paid on the 1st of every month.",
    ...
    answer: 2,
    why: "Affiliate is self-serve at /refer: share of theoretical house edge, not NGR. Live rate shows after login. Staff lock is 15%, claim daily. No dashboard — that is for NGR deals only.",
  },
  {
    id: "agent-pay",
    q: "How do agents get paid?",
    choices: [
      "NGR only, crypto, paid on the 1st of every month. Starts at 10%.",
      "Same as affiliates — daily claim on /refer.",
      "Salary plus NGR.",
      "Whenever they hit $500 in deposits.",
    ],
    answer: 0,
    why: "Agents: NGR only — gross gaming revenue on their players minus player bonuses. Paid on the 1st of every month, crypto. Quiet book = quiet payday.",
  },
  {
    id: "spoken",
    ...
    choices: [
      ...
      "10% NGR, paid on the 1st of every month.",
      "Whatever Stake is paying them, we’ll match.",
      "I can’t say a number until they send players.",
    ],
    answer: 1,
    why: "Every agent starts at 10% NGR, paid the 1st. Higher tiers exist and are never revealed by staff — Adam or Doel raise a real book. Do not auction.",
  },
  {
    id: "higher",
    ...
    choices: [
      ...
      "Invent a hybrid: NGR plus $50 per FTD.",
      "Hold 10% NGR. Conversion story on a new book. One next step (Adam). Stop.",
      "Send them to /refer so they at least have something.",
    ],
    answer: 2,
    why: "Staff never reveal a higher tier. Window-shoppers collect ceilings. The close is conversions on a new book, not a bigger %. Any number beyond 10% is Adam's written approval.",
  },
  {
    id: "refer-door",
  ...
  },
  {
    ...
    choices: [
      ...
      "No. Lossback up to 20% instant cash (zero wagering) is a player deal. Agent pay is their NGR % (starts at 10%). Don’t conflate.",
      "Close enough; use whichever number lands them.",
      "Lossback is the affiliate product.",
    ],
    answer: 1,
    why: "20% lossback ≠ agent NGR ≠ the sub-agent 20% override. Site rakeback is another thing (player’s own play, claimable). Don’t mash them.",
  },
  {
    id: "tipster",
  ...
  },
  {
    ...
    choices: [
      ...
      "Same product as other converting partners: 10% NGR to start, paid the 1st. If they only want a self-serve link, that’s /refer — not NGR. We don’t pay % of deposits.",
  ...
  },
  {
    ...
    choices: [
      ...
      "No. VPN/proxy to evade a geoblock is a terms breach — access refused, account suspended or closed. The live geoblock is the source of truth.",
      "Only for sports.",
